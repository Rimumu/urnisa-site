...
const GachaDev: React.FC = () => {
    ...
    const [keys, setKeys] = useState({ lambKeys: 999, wagyuKeys: 999 });
    ...
    // Fetch Keys on mount/user change (Dev mocked)
    useEffect(() => {
        // In Dev mode we just mock having 999 key
        setKeys({ lambKeys: 999, wagyuKeys: 999 });
    }, [user]);
    ...
    const handleOpenCrate = async (type: CrateType) => {
        ...
        setTimeout(() => {
            ...
            else setKeys(k => ({ ...k, wagyuKeys: k.wagyuKeys - 1 }));
                        ...
                        {stage === 'pre_opening' && (
                            selectedCrate === 'lamb' ? (
                                ...
                                <svg 
                                    ...
                                    style={{ left: '50%', top: '61.33%' }}
                                    viewBox="0 0 24 24" 
                                    fill="url(#wagyuKeyInsertGradDev)" 
                                    stroke="#451a03" 
                                    strokeWidth="1.2" 
                                    strokeLinecap="round" 
                                    strokeLinejoin="round"
                                >
                                    <defs>
                                        <linearGradient id="wagyuKeyInsertGradDev" x1="0" y1="0" x2="1" y2="1">
                                            <stop offset="0%" stopColor="#7a2034"/>
                        ...
                        <div className="flex flex-col items-center animate-in slide-in-from-bottom-8 duration-500 delay-300 fill-mode-both select-none relative z-30">
                            ...
                            >
                                {selectedCrate === 'lamb' ? (
                                    ...
                                    >
                                        <defs>
                                            <linearGradient id="wagyuKeyDragGradDev" x1="0" y1="0" x2="1" y2="1">
                                                <stop offset="0%" stopColor="#7a2034"/>
                                                <stop offset="50%" stopColor="#fb7185"/>
                                                <stop offset="100%" stopColor="#9f1239"/>
                                            </linearGradient>
