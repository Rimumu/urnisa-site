...
const Admin: React.FC = () => {
    ...
    const [generatedCodeList, setGeneratedCodeList] = useState<Code[]>([]); // renamed to avoid conflict
    ...
    const fetchCodes = useCallback(async () => {
        try {
            ...
            if (res.ok) {
                setGeneratedCodeList(await res.json());
            }
        } catch(e) {}
    }, [password]);
