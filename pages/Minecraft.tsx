...
const Minecraft: React.FC = () => {
    ...
    return (
        <div className="min-h-screen py-8 font-sans text-white relative">
            ...
            {/* Content Grid */}
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">

                {/* Navigation Boxes (Symmetrical 2 cards per line grid) */}
                <div className="lg:col-span-7 xl:col-span-8 flex flex-col">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 h-full">
                        {/* Nisamon Shop */}
                        <Link to="/minecraft/shop" className="bg-black/40 backdrop-blur-md border border-brand-accent/30 hover:border-brand-accent/60 p-6 sm:p-7 rounded-3xl shadow-xl relative overflow-hidden hover:scale-[1.02] transition-all duration-300 group flex flex-col justify-between h-full min-h-[190px]">
                            <div className="absolute top-0 right-0 w-28 h-28 bg-brand-accent/10 rounded-full blur-xl pointer-events-none -translate-y-1/2 translate-x-1/2"></div>
                            <div>
                                <div className="flex items-center gap-3.5 mb-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-brand-accent/10 group-hover:bg-brand-accent/20 flex items-center justify-center text-brand-accent shrink-0 transition-colors shadow-inner">
                                    ...
                                    <h2 className="text-xl font-black text-white uppercase tracking-wide group-hover:text-brand-accent transition-colors">SHOP</h2>
                                </div>
                                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
                                    Spend your Nisaballs here and buy Crate Keys, TCG Packs and Cosmetics!
                                </p>
                            </div>
                            <div className="mt-6 flex items-center text-brand-accent font-extrabold text-xs sm:text-sm uppercase tracking-wider gap-2">
                        ...
                        {/* Gacha Crate - OPEN */}
                        <Link to="/minecraft/gacha" className="bg-black/40 backdrop-blur-md border border-amber-500/30 hover:border-amber-400/60 p-6 sm:p-7 rounded-3xl shadow-xl relative overflow-hidden hover:scale-[1.02] transition-all duration-300 group flex flex-col justify-between h-full min-h-[190px]">
                            <div className="absolute top-0 right-0 w-28 h-28 bg-amber-500/10 rounded-full blur-xl pointer-events-none -translate-y-1/2 translate-x-1/2"></div>
                            <div>
                                <div className="flex items-center gap-3.5 mb-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-amber-500/10 group-hover:bg-amber-500/20 flex items-center justify-center text-amber-400 shrink-0 transition-colors shadow-inner">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <h2 className="text-xl font-black text-white uppercase tracking-wide group-hover:text-amber-400 transition-colors">Gacha Crate</h2>
                                </div>
                                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
                                    Try your luck and open a lamb or wagyu crate to see if you'll get some delicious rewards!
                                </p>
                            </div>
                            <div className="mt-6 flex items-center text-amber-400 font-extrabold text-xs sm:text-sm uppercase tracking-wider gap-2">
                        ...
                        <div className="bg-black/30 backdrop-blur-sm border border-white/10 p-6 sm:p-7 rounded-3xl shadow-xl relative overflow-hidden opacity-50 cursor-not-allowed grayscale flex flex-col justify-between h-full min-h-[190px]">
                            <div>
                                <div className="flex items-center gap-3.5 mb-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-[#60a5fa]/20 flex items-center justify-center text-[#60a5fa] shrink-0 shadow-inner">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/></svg>
                                    </div>
                                    <h2 className="text-xl font-black text-white uppercase tracking-wide">Bingo Card</h2>
                                </div>
                                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
                                    Join the community bingo challenge with everyone and compete to finish first for server rewards!
                                </p>
                            </div>
                        ...
                        <div className="bg-black/30 backdrop-blur-sm border border-white/10 p-6 sm:p-7 rounded-3xl shadow-xl relative overflow-hidden opacity-50 cursor-not-allowed grayscale flex flex-col justify-between h-full min-h-[190px]">
                            <div>
                                <div className="flex items-center gap-3.5 mb-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-purple-500/20 flex items-center justify-center text-purple-400 shrink-0 shadow-inner">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/></svg>
                                    </div>
                                    <h2 className="text-xl font-black text-white uppercase tracking-wide">Ranked</h2>
                                </div>
                                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
                                    Climb the Nisamon ranked ladder and battle top players to earn some rewards!
                                </p>
                            </div>
                            <div className="mt-6 flex items-center text-gray-500 font-bold text-xs sm:text-sm uppercase tracking-wider">
                                COMING SOON
                        ...
                        <div className="bg-black/30 backdrop-blur-sm border border-white/10 p-6 sm:p-7 rounded-3xl shadow-xl relative overflow-hidden opacity-50 cursor-not-allowed grayscale flex flex-col justify-between h-full min-h-[190px]">
                            <div>
                                <div className="flex items-center gap-3.5 mb-3.5">
                                    <div className="w-12 h-12 rounded-2xl bg-emerald-500/20 flex items-center justify-center text-emerald-400 shrink-0 shadow-inner">
                                    ...
                                    <h2 className="text-xl font-black text-white uppercase tracking-wide">World Map</h2>
                                </div>
                                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed font-medium">
                                    View a real-time interactive server map that shows live player positions and waypoints!
                                </p>
                            </div>
                            <div className="mt-6 flex items-center text-gray-500 font-bold text-xs sm:text-sm uppercase tracking-wider">
                                COMING SOON
                ...
                {/* How to Join Section */}
                <div className="lg:col-span-5 xl:col-span-4 bg-black/30 backdrop-blur-lg border border-white/10 p-8 rounded-[2.5rem] shadow-xl flex flex-col h-full">
