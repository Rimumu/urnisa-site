...
const Overlay: React.FC = () => {
    return (
        <div className="w-screen h-screen bg-black/80 font-sans text-white p-10 flex flex-col items-center justify-center gap-10">
            ...
            <div className="flex flex-wrap items-end justify-center gap-10">
                <div className="border border-dashed border-gray-600 p-2 relative">
                    <div className="absolute -top-6 left-0 text-xs text-gray-400">Timer (680x250)</div>
